"""
Django settings for red_silence_39732 project.
...
ROOT_URLCONF = 'red_silence_39732.urls'
...
WSGI_APPLICATION = 'red_silence_39732.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "red_silence_39732 API",
    "DESCRIPTION": "API documentation for red_silence_39732 App",
    "VERSION": "v1",
}
